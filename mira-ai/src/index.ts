...
import getPr from "./githhub/actions/get-pr";
import addComment from "./githhub/actions/comment";
import mergePr from "./githhub/actions/merge-pr";
import reward from "./githhub/actions/reward";
import reviewPr from "./githhub/actions/review-changes";
import sendMT from "./githhub/actions/send-metadata";
...
export const miraPlugin: Plugin = {
  name: "Mira",
  description: "Mira Plugin for Eliza",
  actions: [createIssue, getPr, addComment, mergePr, reward, reviewPr, sendMT],
  evaluators: [],
  providers: [],
};
